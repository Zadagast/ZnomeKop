...
- Top-down **32×32** tilemap, custom-drawn under strict GB-Pokemon style rules
  (mostly-white ground, bold 2px outlines, one ordered motif per tile,
  25% checker dither reserved for roofs/cliff faces)
- **96×64 buildings** (3×2 tiles, centered door) with Y-sorted sprites
- Creature sprites generated by a ported
  [pixel-sprite-generator](https://github.com/zfedoran/pixel-sprite-generator)
  (MIT) — see `ATTRIBUTION.md`
- Regenerate all art: `python3 tools/make_tiles.py` (deterministic)
